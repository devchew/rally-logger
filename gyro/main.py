...
log = open('file.csv', mode='w')
log.write("ts,g_x,g_y,g_z,a_x,a_y,a_z,r_x,r_y \n")
...
while True:
    ...
    #print ("y_rotation: ", y)
    #print ("***************************")
    log.write(f'{time.time()},{(gyro_xout / 131)},{(gyro_yout / 131)},{(gyro_zout / 131)},{accel_xout_scaled},{accel_yout_scaled},{accel_zout_scaled},{x},{y}\n')
